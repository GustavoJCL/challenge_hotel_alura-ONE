...
public class Login extends JFrame {
  ...
  public Login(
    ...
    txtContrasena.setText("********");
    txtContrasena.addMouseListener(
        new MouseAdapter() {
          @Override
          public void mousePressed(MouseEvent e) {
  ...
  private void Login() {
    ...
    if (usuarioDao.findByNamePassword(txtUsuario.getText(), contrase)) {
      // if (txtUsuario.getText().equals(Usuario) &&
      // contrase.equals(Contraseña)) {
      MenuUsuario menu = new MenuUsuario(formaPagoDao, huespedDao, reservaDao, usuarioDao);

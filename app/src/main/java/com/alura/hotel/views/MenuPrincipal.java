...
public class MenuPrincipal extends JFrame {
  ...
  public MenuPrincipal(
    ...
    setIconImage(
        Toolkit.getDefaultToolkit()
            .getImage(MenuPrincipal.class.getResource("/imagenes/aH-40px.png")));
    ...
    JLabel lblCopyR = new JLabel("Desarrollado por Gustavo © 2023");
    ...
    btnLogin.addMouseListener(
        new MouseAdapter() {
          @Override
          public void mouseClicked(MouseEvent e) {
            Login login = new Login(formaPagoDao, huespedDao, reservaDao, usuarioDao);
  ...
  // Código que permite movimentar a janela pela tela seguindo a posição de "x"
  // e "y"

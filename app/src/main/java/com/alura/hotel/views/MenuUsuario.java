  ...
  public MenuUsuario(
    ...
    setIconImage(
        Toolkit.getDefaultToolkit()
            .getImage(MenuUsuario.class.getResource("/imagenes/aH-40px.png")));
    ...
    btnBusqueda.addMouseListener(
        new MouseAdapter() {
          ...
          @Override
          public void mouseClicked(MouseEvent e) {
            Busqueda busqueda = new Busqueda(formaPagoDao, huespedDao, reservaDao, usuarioDao);
    ...
    lblBusquedaDeReservas.setIcon(
        new ImageIcon(MenuUsuario.class.getResource("/imagenes/pessoas.png")));
    ...
    String textoDescripcion = "<html><body>Sistema de reserva de hotel. Controle y administre de forma óptima y fácil"
        + " <br> el flujo de reservas y de huespédes del hotel   </body></html>";
    ...
    String textoDescripcion1 = "<html><body> Esta herramienta le permitirá llevar un control completo y detallado de sus"
        + " reservas y huéspedes, tendrá acceso a heramientas especiales para tareas"
        + " específicas como lo son:</body></html>";

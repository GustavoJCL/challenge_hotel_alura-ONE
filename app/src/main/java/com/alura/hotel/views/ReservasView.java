...
public class ReservasView extends JFrame {
  ...
  public ReservasView(
    ...
    imagenFondo.setIcon(
        new ImageIcon(ReservasView.class.getResource("/imagenes/reservas-img-3.png")));
    ...
    btnexit.addMouseListener(
        new MouseAdapter() {
          ...
          public void mouseClicked(MouseEvent e) {
            MenuPrincipal principal = new MenuPrincipal(formaPagoDao, huespedDao, reservaDao, usuarioDao);
    ...
    txtFechaSalida.addPropertyChangeListener(
        new PropertyChangeListener() {
          public void propertyChange(PropertyChangeEvent evt) {
            // Activa el evento, después del usuario seleccionar las fechas se debe
    ...
    // new String[] { "Tarjeta de Crédito", "Tarjeta de Débito", "Dinero
    // en efectivo" }));
